...
namespace WPFUtility {
    public static class WindowGenerator {
        public static void CreateAndShow(Func<Action, ViewModelBase> contentGenerator, bool resizeable, double height, double width) {
        ...
        public static bool? CreateAndShowModal(Func<Action, ViewModelBase> contentGenerator, bool resizeable, double height, double width) {
            var window = new VMHostWindowView();
            var content = new VMHostWindowViewModel(contentGenerator(window.Close));
            SetupWindow(window, content, resizeable, height, width);
        ...
        public static void Popup(string message, double height, double width) {
            CreateAndShowModal(x => new MessageViewModel(message), false, height, width);
        }
